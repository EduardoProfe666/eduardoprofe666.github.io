...
const en: Translations = {
  ...
  "skills.title": "Skills",
  "skills.subtitle": "{count} technologies I build with. Tap one — the grid is tuned to a scale.",
  "skills.all": "All",
  ...
  "cmd.downloadCv": "Download résumé",
  "cmd.shortcuts": "Keyboard shortcuts",
  "keys.spotlight": "Open search",
  "keys.sound": "Mute or unmute",
  "keys.help": "This sheet",
  ...
  "work.ecos.title": "Fullstack Developer",
  ...
  "work.medialityc.title": "Backend Developer / Project Manager",
  ...
  "work.aica.title": "Software Engineer",
  ...
  "work.cujae-prof.title": "Teaching Assistant / Professor",
  ...
  "education.cujae.degree":
    "Computer Engineering Graduate - Gold Title Honors (GPA: 5.0/5.0)",
  ...
  "project.anime.description":
    "Telegram bot for downloading Spanish-subtitled anime",
  ...
  "event.copa2023.description":
    "First Place in the event with my team Error404",
