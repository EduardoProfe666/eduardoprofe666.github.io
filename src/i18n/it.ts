...
const it: Translations = {
  ...
  "skills.subtitle": "{count} tecnologie con cui costruisco. Toccane una — la griglia è accordata.",
  "skills.all": "Tutte",
  "skills.group.languages": "Linguaggi",
  "skills.group.frontend": "Frontend",
  "skills.group.backend": "Backend e dati",
  "skills.group.cloud": "Cloud e DevOps",
  "skills.group.ai": "IA e mobile",
  ...
  "nav.soundOn": "Attiva l’audio",
  "nav.soundOff": "Disattiva l’audio",
  "nav.volume": "Volume",
  "contact.copied": "Email copiata",
  "cmd.open": "Cerca",
  "cmd.placeholder": "Cerca o vai a…",
  "cmd.empty": "Nessun risultato",
  "cmd.goto": "Vai a",
  "cmd.actions": "Azioni",
  "cmd.settings": "Impostazioni",
  "cmd.top": "Inizio",
  "cmd.copyEmail": "Copia l’indirizzo email",
  "cmd.downloadCv": "Scarica il CV",
  "cmd.shortcuts": "Scorciatoie da tastiera",
  "keys.spotlight": "Apri la ricerca",
  "keys.sound": "Muto o attivo",
  "keys.help": "Questo pannello",
  "keys.move": "Sposta la selezione",
  "keys.run": "Esegui",
  "keys.close": "Chiudi",
  "nav.language": "Lingua",
  "thesis.label": "Tesi",
