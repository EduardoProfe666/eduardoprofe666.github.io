...
const fr: Translations = {
  ...
  "skills.subtitle": "{count} technologies avec lesquelles je construis. Touchez-en une — la grille est accordée.",
  "skills.all": "Toutes",
  "skills.group.languages": "Langages",
  "skills.group.frontend": "Frontend",
  "skills.group.backend": "Backend et données",
  "skills.group.cloud": "Cloud et DevOps",
  "skills.group.ai": "IA et mobile",
  ...
  "cmd.open": "Rechercher",
  "cmd.placeholder": "Rechercher ou aller à…",
  "cmd.empty": "Aucun résultat",
  "cmd.goto": "Aller à",
  "cmd.actions": "Actions",
  "cmd.settings": "Réglages",
  "cmd.top": "Haut",
  "cmd.copyEmail": "Copier l’adresse e-mail",
  "cmd.downloadCv": "Télécharger le CV",
  "cmd.shortcuts": "Raccourcis clavier",
  "keys.spotlight": "Ouvrir la recherche",
  "keys.sound": "Couper ou activer le son",
  "keys.help": "Cette fiche",
  "keys.move": "Déplacer la sélection",
  "keys.run": "Exécuter",
  "keys.close": "Fermer",
  "nav.language": "Langue",
  "thesis.label": "Thèse",
