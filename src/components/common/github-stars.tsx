...
export function GitHubStars({ repo }: { repo: string }) {
  ...
  return (
    <span className="group/stars inline-flex items-center gap-1 text-2xs text-muted-foreground bg-secondary/50 px-2 py-0.5 rounded-full border border-border hover:border-yellow-500/30 hover:bg-yellow-500/5 transition-all duration-240 ease-state cursor-default">
