...
const buttonVariants = cva(
  ...
  "inline-flex select-none items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-[transform,background-color,color,box-shadow,opacity] duration-240 ease-state active:scale-[0.94] active:duration-100 disabled:pointer-events-none disabled:opacity-50 disabled:active:scale-100",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground elevate-1 hover:bg-primary/90",
        destructive:
          "bg-destructive text-destructive-foreground elevate-1 hover:bg-destructive/90",
        outline:
          "border border-input bg-background elevate-1 hover:bg-accent hover:text-accent-foreground",
        secondary:
          "bg-secondary text-secondary-foreground elevate-1 hover:bg-secondary/80",
