  ...
  return (
    ...
    <div className="relative ml-10 py-4 group">
      ...
      <div className="absolute -left-16 top-4 flex items-center justify-center">
        <div className={`absolute -left-[23.5px] top-1/2 -translate-y-1/2 z-10 size-3 rounded-full border-2 transition-all duration-500 ease-glide ${
          award
        ...
        <Avatar className="size-12 border shadow-sm transition-[transform,box-shadow] duration-500 ease-glide group-hover:shadow-lg group-hover:scale-[1.06]">
          <AvatarImage
            src={image}
            alt={title}
      ...
      {/* Content */}
      <div className="flex flex-1 flex-col justify-start gap-1.5 rounded-xl p-3 -ml-3 transition-[transform,background-color] duration-500 ease-glide hover:bg-accent/30 hover:-translate-y-0.5">
        <div className="flex items-center gap-2">
          <h2 className="font-semibold leading-none text-sm transition-transform duration-500 ease-glide group-hover:translate-x-0.5">
            {title}
          </h2>
          {award && (
            <Trophy className="size-3.5 text-yellow-500/60 transition-all duration-500 ease-spring group-hover:text-yellow-500 group-hover:rotate-[-8deg] group-hover:scale-110" />
          )}
        </div>

        <div className="flex items-center gap-3 flex-wrap transition-transform duration-500 ease-glide delay-75 group-hover:translate-x-0.5">
          {dates && (
